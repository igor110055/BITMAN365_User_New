            ...
            <div class="data_content">
                <div class="data_list">
                    ...
                    <ul style="list-style: disc;" class="dashed">
                        <li><a href="./" class="lsidebar">마감예약</a></li>
                        <li style="color: #FFF200;"><a href="./btcusd_history.php" class="lsidebar active">BTC/USD 내역</a></li>
                        <li>ETH/USD 내역</li>
                        <li>XRP/USD 내역</li>
                    </ul>
                </div>
                    ...
                    <table style="width: 100%;">
                        <thead id="thead_history">
                            <tr>
                                ...
                                <th>확정시간</th>
                                <th>변경여부</th>
                                <th>매수배팅대기<br>매수당첨</th>
                                <th>매도배팅대기<br>매도당첨</th>
                            </tr>
                        </thead>
