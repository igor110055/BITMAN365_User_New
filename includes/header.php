    ...
    if(count(@$_SESSION)){
        echo '
            <div class="current_stocks_mobile">
                <a href="#"><span class="current_stocks"><img src="assets/icons/dollar_mint.png" class="dollar_mint">'.number_format(@$_SESSION["user_session"]["t_Amount_in_Total"]).'원</span></a>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="header_btn" style="text-align: center;">
